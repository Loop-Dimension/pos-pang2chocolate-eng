...
class _RegistrationScreenState extends ConsumerState<RegistrationScreen> {
  ...
  Widget _buildInputBox({required String hint, required TextEditingController controller, Widget? suffix}) {
    return Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Goals
              Text('목표', style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.bold, color: Colors.black87)),
              SizedBox(height: 4.h),
              Text(
              ...
              // Guide 1
              Text('제휴 입점 안내', style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.bold, color: Colors.black87)),
              SizedBox(height: 4.h),
              Text(
              ...
              // Guide 2
              Text('정산 및 환불 안내', style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.bold, color: Colors.black87)),
              SizedBox(height: 4.h),
              Text(
              ...
              _buildInputBox(hint: '예) 네이버 지도 or 플랫폼 링크...', controller: _storeLinkController),

              _buildSectionTitle('반경 3km 내 독점하고 싶은 품목'),
              _buildInputBox(hint: '예) 주유소, 호텔, 펜션, 음식점, 카페...', controller: _exclusionItemsController),
              ...
              Text(
                ...
                style: TextStyle(fontSize: 11.sp, color: Colors.black87, height: 1.4),
              ),

              _buildSectionTitle('사업자 인증'),
              _buildInputBox(hint: '사업자등록번호', controller: _bizRegNumController, suffix: _buildVerifyButton('확인')),
              ...
              _buildInputBox(hint: '휴대폰 번호', controller: _phoneController, suffix: _buildVerifyButton('본인인증')),
              _buildInputBox(hint: '이메일', controller: _emailController),

              _buildSectionTitle('정산계좌'),
              _buildInputBox(hint: '', controller: _accountController, suffix: _buildVerifyButton('확인')),
              ...
              _buildInputBox(hint: '가게 전화번호', controller: _storePhoneController),
